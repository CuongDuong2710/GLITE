...
import com.glite.popeyes.view.custom.datepicker.SlideDateDialogFragment;
...
public class SlideTimePicker {
    ...
    public void show()
    {
        ...
        SlideTimeDialogFragment dialogFragment =
                SlideTimeDialogFragment.newInstance(
                        mListener,
                        mInitialDate,
                        mMinDate,
                        mMaxDate,
    ...
    public static class Builder
    {
        ...
        /**
         * @see SlideTimePicker#setListener(SlideTimeListener)
         */
